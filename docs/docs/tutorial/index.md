...
curl -L -o - https://github.com/input-output-hk/cardano-node/releases/download/8.10.0/cardano-node-8.10.0-linux.tar.gz \
...
curl -L -o - https://github.com/input-output-hk/cardano-node/releases/download/8.10.0/cardano-node-8.10.0-macos.tar.gz \
